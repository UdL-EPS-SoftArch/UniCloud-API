    ...
    public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                    ...
                    .antMatchers(HttpMethod.POST, "/universities").denyAll()
                    .antMatchers(HttpMethod.PUT, "/universities/*").hasRole("ADMIN")
                    .antMatchers(HttpMethod.PUT, "/universities/*").denyAll()
                    .antMatchers(HttpMethod.PATCH, "/universities/*").hasRole("ADMIN")
                    .antMatchers(HttpMethod.PATCH, "/universities/*").denyAll()
                    .antMatchers(HttpMethod.DELETE, "/universities/*").hasRole("ADMIN")
                    .antMatchers(HttpMethod.DELETE, "/universities/*").denyAll()
