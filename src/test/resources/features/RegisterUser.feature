Feature: Register User
  ...
  Scenario: Register new user
    ...
    When I register a new user with username "user", email "user@gmail.com" and password "password"
    Then The response code is 201
    And It has been created a user with username "user" and email "user@gmail.com", the password is not returned
    And I can login with username "user" and password "password"

  Scenario: Register existing username
    Given There is a registered user with username "user" and password "existing" and email "user@gmail.com"
    And I'm not logged in
    When I register a new user with username "user", email "user@gmail.com" and password "newpassword"
  ...
  Scenario: Register user with empty password
    ...
    When I register a new user with username "user", email "user@gmail.com" and password ""
  ...
  Scenario: Register user with invalid email
    Given I'm not logged in
    When I register a new user with username "user", email "useraagmail.com" and password "password"
    Then The response code is 400
  ...
  Scenario: Register user with password shorter than 8 characters
    Given I'm not logged in
    When I register a new user with username "user", email "user@gmail.com" and password "pass"
    Then The response code is 400
  ...
  Scenario: Register user with an existing email
    ...
    And I'm not logged in
    When I register a new user with username "user2", email "user@gmail.com" and password "password2"
    Then The response code is 409
    And I can login with username "user" and password "password"
