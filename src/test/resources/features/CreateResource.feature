Feature: Create Resource
  ...
  Scenario: Create a new resource as a student with empty name
    Given I login as "student" with password "password"
    When I create a resource with name "", description "description" and filename "example.pdf", and resource type "NOTE" for the subject id 1
    Then The response code is 400

  Scenario: Create a new resource as a student with empty file
    Given I login as "student" with password "password"
    When I create a resource with name "name", description "description" and filename "", and resource type "NOTE" for the subject id 1
    Then The response code is 400

  Scenario: Create a new resource as a student with an already existing name
    Given I login as "student" with password "password"
    And There is a registered resource with name "name" by the user "user", with description "description", file "example.pdf", and resource type "NOTE" for the subject "subject"
    When I create a resource with name "name", description "description" and filename "example.pdf", and resource type "NOTE" for the subject id 1
    Then The response code is 409
    And The resource count is 1

  Scenario: Create a new resource as a student with a non-existent subject
    Given I login as "student" with password "password"
    When I create a resource with name "name", description "description" and filename "example.pdf" for the subject id 99
    Then The response code is 400
    And The resource count is 1